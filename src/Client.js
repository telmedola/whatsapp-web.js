...
class Client extends EventEmitter {
    ...
    */
    ...
    async saveOrEditAddressbookContact(phoneNumber, firstName, lastName, syncToAddressbook = false) {
        const phoneWid = phoneNumber.endsWith('@c.us') ? phoneNumber : phoneNumber + '@c.us';

        return await this.pupPage.evaluate(async (phoneWid, phoneNumber, firstName, lastName, syncToAddressbook) => {
            const wid = window.Store.WidFactory.createWid(phoneWid);
        ...
        }, phoneWid, phoneNumber, firstName, lastName, syncToAddressbook);
    }
